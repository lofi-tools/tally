...
impl TestData {
    ...
    ///
    /// Only `example_data/example2/example2.gnucash` is tied to a company
    ...
    pub fn accounts_path(company_number: &str) -> Option<&'static str> {
        match company_number {
            "12345678" => Some("example_data/example2/example2.gnucash"),
            _ => None,
        }
    }
}
...
mod tests {
    ...
    fn accounts_path_maps_example_company() {
        assert_eq!(
            ...
            Some("example_data/example2/example2.gnucash")
        );
