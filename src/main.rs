use balance_sheet::SumBalances;
use chrono::NaiveDate;
use std_accounts::*;

use crate::profit_and_loss::ProfitAndLoss;
...
// pub mod balance_sheet {
//     pub trait BalanceSheetEntryKind {
//         fn asset_or_liability() -> EitherAssetOrLiability;
//     }

//     pub enum EitherAssetOrLiability {
//         Asset,
//         Liability,
//     }

//     pub trait Asset {}
//     impl<T: Asset> BalanceSheetEntryKind for T {
//         fn asset_or_liability() -> EitherAssetOrLiability {
//             EitherAssetOrLiability::Asset
//         }
//     }
//     pub trait Liability {}
//     impl<T: Liability + !Asset> BalanceSheetEntryKind for T {
//         fn asset_or_liability() -> EitherAssetOrLiability {
//             EitherAssetOrLiability::Liability
//         }
//     }
// }
